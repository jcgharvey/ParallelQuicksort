...
import se751.team13.quicksort.pyjama.*;//#GEN#[6]#PJ#
public class _omp__parallelRegionVarHolderClass_PyjamaQuickSorter0 {//#GEN#[6]#PJ#
//#GEN#[6]#PJ#

    public int pivotIndex; // Auto-saved
    public int left; // Auto-saved
    public int right; // Auto-saved
    public int pivotNewIndex; // Auto-saved
}//#GEN#[6]#PJ#
